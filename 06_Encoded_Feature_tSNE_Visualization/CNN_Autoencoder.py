...
class CNN_Autoencoder(nn.Module):
    ...
    def __init__(self, device=None, input_size=[1, 3, 100, 100], batch_size=1, learning_rate=0.001):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), output_padding=(1, 1), bias=False),
            nn.BatchNorm2d(32),
            nn.LeakyReLU(0.1),

            nn.ConvTranspose2d(in_channels=32, out_channels=input_size[1], kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), output_padding=(1, 1), bias=False),
        )
